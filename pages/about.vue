<template>
  <div>
    <!-- Sub banner start -->
    <lazy-car-banner title="About Us"></lazy-car-banner>
    <!-- Sub Banner end -->
    <!-- About car start -->
    <div class="about-car">
      <div class="container">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 text-center">
            <a class="btn-4" href="/services"> <span>Learn More</span> <i class="arrow"></i> </a>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- Counters end -->
    <!-- Our team start -->
    <lazy-car-our-team></lazy-car-our-team>
    <!-- Our team end -->
    <!-- Testimonial start -->
            ...
            <div class="testimonial-info">
              ...
              <div class="text">
                <p>
                  ...
                  amount of money .Lorem ipsum dolor sit amet consectetur adipisicing elit."
                </p>
              </div>
            </div>
          </div>
