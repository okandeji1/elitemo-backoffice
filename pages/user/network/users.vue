<template>
  <main>
    <lazy-car-user-header title="Users" icon="transaction-list" />
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { name: 'firstName', dataIndex: 'firstName', key: 'firstName', title: 'First Name', scopedSlots: { customRender: 'firstName' } },
        {
          name: 'lastName',
          dataIndex: 'lastName',
          key: 'lastName',
