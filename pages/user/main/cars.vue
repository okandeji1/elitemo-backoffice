<template>
  <main>
    <lazy-car-user-header title="Cars" icon="transaction-list" />
    ...
    <div class="m-4 transaction-table">
      ...
      <a-table
        ...
        bordered
      >
        <template slot="make" slot-scope="index, record">
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { name: 'model', dataIndex: 'model', key: 'model', title: 'Model', scopedSlots: { customRender: 'model' } },
        {
          name: 'brand',
          dataIndex: 'brand',
          key: 'brand',
